...
public class Cube extends Geometry {
    ...
    public Cube(Material material) {
        ...
        sq1.rotate(new Quaternion(3.1415926535897932384626433832795 / 2.0, 1.0, 0.0, 0.0));
        merge(sq1);

        Square sq2 = new Square(material);
        sq2.translate(new Vector3D(0.0, 0.0, 0.5));
        sq2.rotate(new Quaternion(3.1415926535897932384626433832795, 1.0, 0.0, 0.0));
        merge(sq2);

        Square sq3 = new Square(material);
        sq3.translate(new Vector3D(0.0, 0.0, 0.5));
        sq3.rotate(new Quaternion(-3.1415926535897932384626433832795 / 2.0, 1.0, 0.0, 0.0));
        merge(sq3);

        Square sq4 = new Square(material);
        sq4.translate(new Vector3D(0.0, 0.0, 0.5));
        sq4.rotate(new Quaternion(3.1415926535897932384626433832795 / 2.0, 0.0, 1.0, 0.0));
        merge(sq4);

        Square sq5 = new Square(material);
        sq5.translate(new Vector3D(0.0, 0.0, 0.5));
        sq5.rotate(new Quaternion(-3.1415926535897932384626433832795 / 2.0, 0.0, 1.0, 0.0));
        merge(sq5);
    }
}
